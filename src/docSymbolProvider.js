...
class GitConfigDocumentSymbolProvider 
{
    provideDocumentSymbols(document, token) 
    {
        ...
        for (let line = 0; line < document.lineCount; line++) {
            ...
            if (secMatched) {
                ...
                // 记录下新段的信息
                // Record the information of the new paragraph
            ...
            // 匹配键（注意：键必须位于最近的段下面）
            // Match key (note: key must be located below the nearest segment)
        ...
        // Remember: close the last paragraph!
        if (prevSecName != null)
        {
...
exports.GitConfigDocumentSymbolProvider = GitConfigDocumentSymbolProvider;
